...
module.exports = {
    name: 'bakiyeyükle',
    description: 'Belirli bir kullanıcının bakiyesine yükleme yapar.',
    execute(message, args) {
        ...
        try {
            ...
            const embed = new MessageEmbed()
                .setColor('#00ff00')
                .setDescription(`${kullanıcı.username} adlı kullanıcının bakiyesine ${miktar} ${tür} parası başarıyla yüklendi.`);
